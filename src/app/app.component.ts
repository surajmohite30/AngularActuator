...
MemoryUse(){
 this.actuatorService.memoryInfo().subscribe(res=>{
  this.memory=res;
  this.total=['Free',Math.round((this.memory.details.free)/1073741824)]
  this.free=['Used',Math.round((this.memory.details.total)/1073741824-(this.memory.details.free)/1073741824)]
